...
class CorrelationCoeff:
    ...
    def importData(self):
        # Import data
        self.__rat_lst = Reviews.query.with_entities(Reviews.actual_sentiment)
        self.__lstm_rat = Reviews.query.with_entities(Reviews.lstm_prediction)
        self.__bayes_rat = Reviews.query.with_entities(Reviews.bayes_prediction)        
        
    def performCorrelation(self):
        lstm_r = pearsonr(self.__rat_lst, self.__lstm_rat)
        bayes_r = pearsonr(self.__rat_lst, self.__bayes_rat)
