...
r1 = text1.text_area("here's my text", value, key="t1")
r2 = text2.text_area("Here's my text2", value, key="t2")
r3 = text3.text_area("Here's my text3", value, key="t3")
